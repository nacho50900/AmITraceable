...
os.environ.setdefault("INSTAGRAM_APP_ID", "test-ig-app-id")
os.environ.setdefault("INSTAGRAM_APP_SECRET", "test-ig-app-secret")
os.environ.setdefault("INSTAGRAM_REDIRECT_URI", "http://localhost:3000/auth/instagram/callback")
